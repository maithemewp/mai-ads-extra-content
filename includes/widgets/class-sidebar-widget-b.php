...
add_action( 'widgets_init', 'mai_aec_register_ad_widget_b' );
function mai_aec_register_ad_widget_b() {
    register_widget( 'Mai_AEC_Widget_B' );
}
...
class Mai_AEC_Widget_B extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'Mai Ad "B"', // Name
			array( 'description' => __( 'Display ad widget "B"', 'mai-ads-extra-content' ), ) // Args
		);
	}
